-- Create a table named orders for activity6
create table orders(
    order_no int primary key, purchase_amount float, order_date date,
    customer_id int, salesman_id int);

-- Add values to the table for 
INSERT ALL
...
SELECT 1 FROM DUAL;
--Activity6:trying Order by with where conditions

--get all salesman id without duplicate
