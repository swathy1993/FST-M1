package stepDefinition;
	...
	public class LoginPage  extends BaseClass {
	    ...
	    @Then("get the confirmation text and verify message as right {string}")
	    public void confirmMessageAsInputright(String expectedMessage) {
	    	// Find the confirmation message
	        wait.until(ExpectedConditions.textToBePresentInElementLocated(By.cssSelector("h2.mt-5"), "Welcome"));
	        String message = driver.findElement(By.cssSelector("h2.mt-5")).getText();
	        // Assert message
	    ...
	    @Then("get the confirmation text and verify failed message as {string}")
	    public void confirmMessageAsInputwrong(String expectedMessage) {
	        // Find the message
